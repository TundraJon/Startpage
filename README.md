...
_**Net result:** the Colors/subcategory/centralized-screen parts of this document are fully superseded by Build 60, per the three resolutions above — nothing new there. The profile-photo-picker part is a genuine, real gap that still needs to be built; it just isn't queued yet, pending its own design pass._
