...
- [x] **Profile photo picker — design resolved, not yet built:**
  ...
  - **Still open, not yet decided:** whether tapping the already-set photo icon re-opens the picker directly to change it, vs. needing a separate "change photo" entry inside Settings (or both) — worth deciding at build time, doesn't block logging this.
