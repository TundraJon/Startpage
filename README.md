...
- [x] **Groupings list inside Edit Category — user approved the proposed default:** ✏️ there scrolls to and selects that divider, entering the same select+bar+inline-rename state, rather than the old popup or the list disappearing outright.
